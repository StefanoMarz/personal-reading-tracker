...
export const BookCard = ({
  ...
  return (
    <li className="flex min-h-96 flex-col rounded-2xl border border-violet-500/20 bg-slate-900 p-4 shadow-lg shadow-black/20">
      <div className="relative">
        <img
          src={book.coverUrl}
          alt={`Copertina di ${book.title}`}
          className="mx-auto h-48 max-w-32 rounded-xl object-cover"
        />
